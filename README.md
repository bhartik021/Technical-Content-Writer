...
|**DBMS**|What is multivalued attribute in DBMS - Scaler Topics|<https://www.scaler.com/topics/multivalued-attribute-in-dbms/>|
...
|**Java**|Java Program to Check the Accessibility of an Static Variable By a Static Method|<https://www.tutorialspoint.com/java-program-to-check-the-accessibility-of-an-static-variable-by-a-static-method>|
...
|**Skill name**|**Proficiency (1-4)**|**Where/how you’ve used this skill**|
| - | - | - |
|Leadership|1|In my community at GFG Student Chapter RTU and in the Samsung Solve for Tomorrow Hackathon to lead my team.|
|ReactJS|2|To build my current project.  |
|HTML, CSS, and SCSS |3|For nearly all my works!|
|JavaScript |3|While working with frontend frameworks, and minimal NodeJS backend work.|
|Technical Writing|2\.5|Writing technical blogs In my Company and on Medium articles.|
|Git, GitHub|3|For nearly all my major projects.|
|Full-Stack Web Development|3|During the Google Solution Challenge 2023 and Self Project.|
|Mentorship|1|In my community at GFG Student Chapter RTU and GirlSript Summer of Code 2023.|

### <a name="_heading=h.bbu5ljmla101"></a>**Experience and Contributions**

|**Brief Description** |**Tools Used** |**Description**|
| - | - | - |
|**Project Maintainer and Mentor at GirlScript Summer of Code 2023**|<p>Tools Used</p><p>- Git</p><p>- Vs Code</p><p></p><p>Project Management Tool:</p><p>- Discord</p>|<p>- Streamlined issue and pull request management and improved team productivity by 25%</p><p>- Conducted code reviews to maintain code quality standards; reduced critical bugs by 40%.</p>|
|**Technical Content Writer at Scaler** |<p>Tools used to write articles:</p><p>- HackMD Space</p><p>- Microsoft Word</p><p>- Google Docs</p><p></p><p>Project Management Tool:</p><p>- Slack</p><p></p>|<p>- Collaborated with the Scaler Topics Technical Content Review Team, contributing to 50+ informative articles. </p><p>- Delivered content on a wide range of topics, including C/C++, HTML/CSS, JavaScript, Operating Systems, DBMS, and MongoDB; resulting in a 40% increase in user engagement. </p><p>- Worked with the SEO team on articles ranging from 800 to 3000 words, adhering to a zero-plagiarism policy. </p><p>- Developed comprehensive scripts and learning materials for the Data Structure and Algorithm course. </p><p>- Crafted FAQs and MCQs for MongoDB learners, covering 40+ technical topics; increased user satisfaction by 30%</p>|
|**Technical Content Writer at Tutorials Point**|<p>Tools used to write articles:</p><p>- Microsoft Word</p><p>- Google Docs</p>|<p>- Collaborated with the content team to develop over 25 articles in SQL and CSS domains with over 42k views. </p><p>- Authored high-quality articles ranging from 700 to 1200 words, ensuring a 100% adherence to quality standards.</p>|
|**Web Development Intern at Artyvis**||<p>- Implemented filter functionality using ReactJS, resulting in a 40% decrease in search time for users. </p><p>- Improved the product page card for seamless navigation resulting in a 25% increase in user engagement. </p>|
|**Founder and Chapter Lead at GFG Student Chapter RTU**||<p>Being a Chapter Lead I am responsible for growing the coding ecosystem at my institute. So far, I have been able to work on the following -</p><p></p><p>- Conducted and organized workshops on various technologies within the college motivated students to start learning technologies, and conducted motivational sessions.</p><p>- Collaborated with 5 communities to increase community involvement. Assisted in organizing national-level hackathons, workshops, and coding competitions.</p><p>- Created and led the core team at GFG Student Chapter RTU.</p><p>- Developed event goals and objectives.</p><p>- Coordinated with various guests and mentors to facilitate the event.</p>|
|**Technical Content Writer Intern at GeeksforGeeks**|<p>Tools used to write articles:</p><p>- Blogging Web App</p><p>- Microsoft Word</p><p>- Google Docs</p>|<p>- Contributed 15 highly informative technical articles on the GeeksforGeeks platform with 50k views. </p><p>- Improved over 10 technical articles for clarity, accessibility, and error-free content. </p><p>- Authored and published a guest blog for their news platform</p>|
